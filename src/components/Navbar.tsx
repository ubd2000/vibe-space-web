...
import { Menu, X, ShoppingBag, Users, Palette, MessageCircle, ShoppingCart } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link to="/become-creator" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors mr-2">
              크리에이터 입점
            </Link>
          ...
          <div className="md:hidden py-4 border-t border-border animate-fade-in">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 pt-4 border-t border-border">
                <Link to="/become-creator" onClick={() => setIsOpen(false)}>
